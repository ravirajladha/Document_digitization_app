                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success mb-2 float-end"   data-bs-toggle="modal" data-bs-target="#exampleModalCenter1">Add Receiver</button>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-primary edit-btn"
                                                                ...
                                                                data-receiver-status="{{ $item->status }}">Edit</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                                        ...
                                                        <form id="updateReceiverForm">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="receiverName" name="name">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="receiverPhone"
                                                                    class="form-label">Phone</label>
                                                                <input type="text" class="form-control"
                                                                    id="receiverPhone" name="phone">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="receiverCity"
                                                                    class="form-label">City</label>
                                                                <input type="text" class="form-control"
                                                                    id="receiverCity" name="city">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="receiverEmail"
                                                                    class="form-label">Email</label>
                                                                <input type="email" class="form-control"
                                                                    id="receiverEmail" name="email">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="receiverType" class="form-label">Receiver
                                                                    Type</label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="receiverStatus"
                                                                    class="form-label">Status</label>
                                                                <select class="form-control" id="receiverStatus"
                                                                    name="status">
